...
namespace BookListService.Tests
{
    ...
    {
        [TestCase("Erich Maria Remarque", "Three comrades", "Little, Brown and Company")]
        ...
        [TestCase("Erich Maria Remarque")]
        public void BookService_FindByAuthor(string author)
        {
            BookListService bookListService = new BookListService();

            Book book1 = new Book(string.Empty, string.Empty, "Little, Brown and Company");
            Book book2 = new Book(author, string.Empty, string.Empty);
            Book book3 = new Book(string.Empty, "Three comrades", string.Empty);
            Book book4 = new Book(string.Empty, string.Empty, string.Empty);
            Book book5 = new Book(author, "Three comrades", string.Empty);
        ...
        [TestCase("Three comrades")]
        public void BookService_FindByTitle(string title)
        {
            BookListService bookListService = new BookListService();

            Book book1 = new Book(string.Empty, string.Empty, "Little, Brown and Company");
            Book book2 = new Book("Erich Maria Remarque", string.Empty, string.Empty);
            Book book3 = new Book(string.Empty, title, string.Empty);
            Book book4 = new Book(string.Empty, string.Empty, string.Empty);
            Book book5 = new Book("Erich Maria Remarque", title, string.Empty);
        ...
        [TestCase("Little, Brown and Company")]
        public void BookService_FindByPublisher(string publisher)
        {
            ...
            Book book3 = new Book(string.Empty, "Three comrades", string.Empty);
            Book book4 = new Book(string.Empty, string.Empty, string.Empty);
            Book book5 = new Book("Erich Maria Remarque", "Three comrades", string.Empty);
